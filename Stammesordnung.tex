...
\label{sec:allgemeines}
	\begin{itemize}
		...
		\item Der Stamm Martin Luther Lumdatal hat sich selbst ein Zeichen gegeben. Das Stammeswappen ist nach dem Namensgeber des Stammes die Lutherrose. Sie ist auf der Titelseite dieser Ordnung abgebildet.
...
Stufe werden als Pfadfinder bezeichnet.
    ...
    \label{sub:ranger_rover_stufe}
        \begin{itemize}
            ...
            \item Die Aufnahme in die Ranger/Rover Stufe erfolgt mit Erneuerung des Pfadfinderversprechens durch den Stammesführer. 
        \end{itemize}
...
\label{sec:fuhrungsrunde_und_beauftragungen}
	...
	\begin{itemize}
		...
		\item Es ist möglich zwei Personen als Stammesführer einzusetzen, die beiden Stammesführer treten dann als Team gegenüber der MVV auf. Die Stammesführer koordinieren sich selbst und teilen die Aufgaben unter sich auf. 
